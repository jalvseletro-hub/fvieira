        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs p-3 rounded-xl">
                Para adicionar serviços, utilize o painel <strong>Lançamento Rápido</strong> na tela principal.
              </div>
